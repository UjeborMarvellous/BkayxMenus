    ...
    return (
        <div className=' Snacks'>
            ...
            <div className="content mx-5">
                ...
                <p className='text-lg py-1 flex justify-between'>Chicken Pie <span className='text-white text-4xl ml-[20%] my-auto'><RxDividerHorizontal /></span> 700</p>
                ...
                <p className='text-lg py-1 flex justify-between'>Zeero <span className='text-white text-4xl ml-4 my-auto'><RxDividerHorizontal /></span> 300</p>
                <p className='text-lg py-1 flex justify-between'>BeeroLL<span className='text-white text-4xl ml-4 my-auto'><RxDividerHorizontal /></span> 300</p>
